...
{\color{red} Inserire il fatto che la soluzione di differenziali lineari, la risoluzioni di ricorrenze lineari e il calcolo di potenze di matrici sono lo stesso problema.}
...
{\color{red} Inserire ANNICHILATORI e casi di RISONANZA, anche se la sezione successiva rende tutto obsoleto}
...
{\color{red}\underline{Modificare in: accenni di Analisi 2 e Sistemi Dinamici, integrali primi e funzioni di Lyapunov.}}
