...
$$ I = \int_{-1/2}^{1/2}\int_{-1/2}^{1/2}\sqrt{x^2+y^2}\,dx\,dy \stackrel{\text{simmetria}}{=} \int_{0}^{1}\int_{0}^{1}\sqrt{u^2+v^2}\,du\,dv\stackrel{\text{simmetria}}{=} 2 \int_{0}^{1}\int_{0}^{u}\sqrt{u^2+v^2}\,dv\,du.$$
...
$$ \frac{2}{3}\int_{0}^{1}\sqrt{1+z^2}\,dz \stackrel{z\mapsto \sinh t}{=} \frac{2}{3}\int_{0}^{\arcsinh 1}\cosh^2(t)\,dt=\frac{1}{3}\int_{0}^{\arcsinh 1}\left(1+\cosh(2t)\right)\,dt=\frac{1}{3}\left[t+\sinh(t)\cosh(t)\right]_{0}^{\arcsinh 1}$$
che equivale a 
$$ \frac{1}{3}\left(\arcsinh{1}+\cosh(\arcsinh{1})\right) = \frac{\sqrt{2}+\arcsinh{1}}{3}={\color{blue}\frac{\sqrt{2}+\log(1+\sqrt{2})}{3}}\approx 0.7652. $$
...
dove $F(x)$ denota \emph{una} primitiva (alias antiderivata) di $f(x)$.
